...
public class MainActivity extends AppCompatActivity
{
    ...
    //code to display all the audio songs names
    private void displayAudioSongsName()
    {
        ...
        mSongsList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            {
                String songName = mSongsList.getItemAtPosition(i).toString();//getting song name from the user and storing it in this
